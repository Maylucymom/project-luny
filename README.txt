...
PROJECT LUNA V2.1 DAILY RESET + TRAVEL DIARY
- UTC 날짜 오류를 제거하고 사용자 기기의 현지 날짜를 사용
- 자정/포커스/화면 복귀/pageshow 시 날짜 변경 자동 감지
- 다음 날 루틴·생활습관·두뇌루틴·특별미션 초기화
- 매일 응원 보너스 재활성화
- 사진 최대 4장과 글을 저장하는 여행·관찰일기 추가
- 기존 데이터 및 JSON 백업 구조 유지
